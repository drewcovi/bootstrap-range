...
<body>
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>Slider for Bootstrap <small>bootstrap-rangepicker.js</small></h1>
...
// Without JQuery
var rangepicker = new Slider('#ex1', {
	formatter: function(value) {
		return 'Current value: ' + value;
	}
});
...
// Without JQuery
var rangepicker = new Slider('#ex2', {});
...
// Without JQuery
var rangepicker = new Slider("#ex4", {
	reversed : true
});
